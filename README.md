...
Columns renamed in 2026-08 are translated on read, so the 400-odd archived daily snapshots — the record of what was published on each day — are never rewritten. The old-to-new map is `csv_aliases.py`.
